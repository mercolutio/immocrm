...
export default function PropertyDetailPage() {
  ...
  const gallery = useGallery(id, images, setImages);
  const { coverImage, thumbUrl, uploading, fileInputRef, setShowGallery, setGalleryIdx, uploadFiles } = gallery;
  ...
  return (
    <DashboardLayout>
        ...
        <div className="property-detail anim-0" style={{ display: "flex", gap: 0, flex: 1, overflow: "hidden" }}>
          ...
          >
            ...
            <div style={{ flex: 1, overflowY: "auto", padding: "18px 22px", display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <PropertyForm form={form} updateForm={updateForm} owners={owners} />
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
                  ...
                  {activeTab === "all" ? (
                    <div style={{ position: "relative" }}>
                      ...
                      {activityPop.open && (
                        <div ref={activityPop.popoverRef} className="popover right-anchored">
      ...
      {/* ── GALLERY OVERLAY ── */}
      {gallery.showGallery && <GalleryModal images={images} gallery={gallery} />}
      {/* Floating Save */}
      <style>{`
